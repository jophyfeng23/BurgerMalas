...
<body>
    ...
    <main class="mainContent">
        <section class="franchise-hero">
            ...
            <div class="content">
                <h1><i class="bi bi-bookmark-star"></i> Own a Burger Malas Stall for Under <strong>RM20,000</strong></h1>
                <p class="content-text">Start your business journey with Burger Malas. We make it simple — from supplies to training, we've
                    got you covered.</p>
            </div>
        </section>
        ...
        <section class="franchise-section">
            ...
            <div class="why-join">
                <div class="why-card">
                    ...
                    <h5>Low Start-up Cost</h5>
                    <p>Start your Burger Malas stall for under RM20,000 — affordable, fast, and ready to grow.</p>
                </div>

                <div class="why-card">
                    <span><i class="bi bi-journal-check"></i></span>
                    <h5>Simple Training</h5>
                    <p>No F&B experience? No problem. We train you with easy, proven SOPs that anyone can follow.</p>
                </div>

                <div class="why-card">
                    <span><i class="bi bi-lightning-fill"></i></span>
                    <h5>Fast ROI Potential</h5>
                    <p>Earn back your investment faster with high-demand, low-cost operation stalls.</p>
                </div>

                <div class="why-card">
                    <span><i class="bi bi-buildings"></i></span>
                    <h5>Full HQ Support</h5>
                    <p>We handle supply, marketing, and support so you can focus on serving your customers.</p>
                </div>

                <div class="why-card">
                    <span><i class="bi bi-graph-up-arrow"></i></span>
                    <h5>Proven Business Model</h5>
                    <p>Join a system with a track record of successful stalls, designed to minimize risk and maximize
                        growth.</p>
                </div>
                ...
                <div class="why-card">
                    ...
                    <p>Set up your stall in malls, campuses, or events — our model adapts to any high-traffic area.</p>
                </div>
            </div>

            <div
                class="contact-btn-container d-flex flex-column flex-md-row justify-content-center align-items-center gap-4 mt-5">
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=burgermalas25@gmail.com&su=Franchise%20Inquiry&body=Hi%20Burger%20Malas%20Team,%0D%0A%0D%0AI%20am%20interested%20in%20franchise%20opportunities."
                    ...
                    <i class="bi bi-envelope-arrow-up-fill"></i> Email Us for More Info
                </a>

                <a href="contactus.html" class="btn btn-primary">
                    <i class="bi bi-pencil-square"></i> Leave a Contact Form
                </a>
            </div>
        </section>
